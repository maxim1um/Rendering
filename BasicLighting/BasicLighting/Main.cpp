...
int main(int argc, char* argv[])
{
	...
	Shader phong("phonglighting.vert", "phonglighting.frag");
	Shader gouraud("gouraudlighting.vert", "gouraudlighting.frag");
	...
	// configure cube vertex attributes 
	...
	// configure lamp vertex attributes
	...
	phong.use();
	phong.setVec3("objectColor", 1.0f, 0.5f, 0.31f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// set light position to phong shader
		phong.setVec3("lightPos", lightPos);
		// set view position to phong shader
		phong.setVec3("viewPos", camera.Position);
		...
		// pass projection, view and model matrix to lamp shader
