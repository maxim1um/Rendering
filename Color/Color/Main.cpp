...
int main(int argc, char* argv[])
{
	...
	GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Color", NULL, NULL);
	if (window == NULL)
	{
	...
	// vertex data and buffer and configure vertex attributes
	GLfloat vertices[] = {
		-0.5f, -0.5f, -0.5f,
		0.5f, -0.5f, -0.5f,
		0.5f,  0.5f, -0.5f,
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLfloat currrentFrame = glfwGetTime();
...
GLuint loadTexture(GLchar *path)
{
	// create texture ID and load texture data
	GLuint textureID;
